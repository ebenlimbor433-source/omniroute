...
| Phase 1 guard test                | `tests/unit/misc/design-grid-background.test.ts`                                                                          |
