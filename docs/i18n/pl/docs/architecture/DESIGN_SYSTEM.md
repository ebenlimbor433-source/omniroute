...
| Test-guard Phase 1                   | `tests/unit/misc/design-grid-background.test.ts`                                                                          |
